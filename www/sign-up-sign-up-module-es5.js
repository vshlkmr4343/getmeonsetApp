(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sign-up-sign-up-module"], {
  ...
  function srcAppSignUpSignUpPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _utility_must_match_validator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../utility/must-match.validator */
    ...
    var _sign_in_sign_in_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      signUp() {
        ...
        this.signUpService.signUp(this.signUpForm.value).subscribe(data => {
          ...
          this.storage.set('userData', this.usersDetails.data.userData).then(dataxyz => {
            this.signInService.authStatusListener.next(true); // this.utility.showToast('Successfully signup.')
            ...
            if (this.usersDetails.message) {
              ...
              localStorage.setItem('isLoggedin', 'true'); // store user details and jwt token in local storage to keep user logged in between page refreshes
