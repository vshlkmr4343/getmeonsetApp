(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-user-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserDisplayDisplayComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserFavouriteFavouriteComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserListListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserMyGigMyGigComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserChangePasswordChangePasswordComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppUserChangePasswordChangePasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_utility_must_match_validator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/utility/must-match.validator */
    ...
    var src_app_utility_utility_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    let ChangePasswordComponent = class ChangePasswordComponent {
      ...
      onSubmit() {
        ...
        this.storage.get('userData').then(data => {
          this.userService.changePassword(this.resetForm.value, data.email).subscribe(res => {
    ...
    ChangePasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/user/change-password/change-password.component.scss")).default]
  ...
  /***/
  function srcAppUserDisplayDisplayComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserDisplayDisplayComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_utility_utility_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/utility/utility.service */
    "./src/app/utility/utility.service.ts");
    ...
    let DisplayComponent = class DisplayComponent {
      ...
      getUserProfileInfo(usersId, loggedInUsersId) {
        switch (this.userType) {
          case 'talent':
            this.userService.getUserProfileInfoTalent(this.usersId, this.loggedInUsersId).subscribe(data => {
          ...
          case 'crew':
            this.userService.getUserProfileInfoCrew(this.usersId, this.loggedInUsersId).subscribe(data => {
              this.userProfileInfo = data;
              this.userProfileInfo = this.userProfileInfo.data.userDetails;
              this.address = this.userProfileInfo.usersAddress[0];
              this.reviewDetails = this.userProfileInfo.reviews;
          ...
          case 'producer':
            this.userService.getUserProfileInfoProducer(this.usersId, this.loggedInUsersId).subscribe(data => {
              this.userProfileInfo = data;
              this.userProfileInfo = this.userProfileInfo.data.userDetails;
              this.address = this.userProfileInfo.usersAddress[0];
              this.reviewDetails = this.userProfileInfo.reviews;
          ...
          case 'vendor':
            this.userService.getUserProfileInfo(this.usersId, this.loggedInUsersId).subscribe(data => {
              this.userProfileInfo = data;
              this.userProfileInfo = this.userProfileInfo.data.userDetails;
              this.reviewDetails = this.userProfileInfo.reviews;
              this.address = this.userProfileInfo.usersAddress[0];
        ...
        switch (this.userType) {
          ...
          case 'crew':
            this.userService.getRatingValByUserCrew(this.usersId).subscribe(data => {
              ...
              this.threeStarPercentage = this.rateArr.data.threeStarPercentage / 100;
              this.fourStarPercentage = this.rateArr.data.fourStarPercentage / 100;
              this.fiveStarPercentage = this.rateArr.data.fiveStarPercentage / 100; // console.log('oneStarPercentage',this.oneStarPercentage)
        ...
        switch (this.userType) {
          case 'talent':
            if (this.userProfileInfo.isFavourite == 0) {
              this.userService.addFavoriteTalent(this.userProfileInfo.usersId, this.loggedInUsersId, 1, 3).subscribe(data => {
              ...
              this.userService.removeFavoriteTalent(this.userProfileInfo.usersId, this.loggedInUsersId, 1, 3).subscribe(data => {
                this.favoriteDetails = data;
          ...
          case 'producer':
            if (this.userProfileInfo.isFavourite == 0) {
              this.userService.addFavoriteTalent(this.userProfileInfo.usersId, this.loggedInUsersId, 1, 4).subscribe(data => {
                this.favoriteDetails = data;
                this.isFavorite = this.favoriteDetails.data.isAddedToFavourite;
              ...
              this.userService.removeFavoriteTalent(this.userProfileInfo.usersId, this.loggedInUsersId, 1, 4).subscribe(data => {
                this.favoriteDetails = data;
                this.isRemovedFavorite = this.favoriteDetails.data.isRemoveFromFavourite;
          ...
          case 'vendor':
            if (this.userProfileInfo.isFavourite == 0) {
              this.userService.addFavoriteTalent(this.userProfileInfo.usersId, this.loggedInUsersId, 1, 6).subscribe(data => {
                this.favoriteDetails = data;
                this.isFavorite = this.favoriteDetails.data.isAddedToFavourite;
              ...
              this.userService.removeFavoriteTalent(this.userProfileInfo.usersId, this.loggedInUsersId, 1, 6).subscribe(data => {
                this.favoriteDetails = data;
                this.isRemovedFavorite = this.favoriteDetails.data.isRemoveFromFavourite;
      ...
      addRatingText() {
        ...
        this.userService.updateRatingText(this.lastIdRating, this.usersRatingText, this.rate).subscribe(data => {
      ...
      addRatingAndReview() {
        ...
        this.userService.addRatingAndReview(this.usersId, this.loggedInUsersId, this.usersRatingText, this.usersRatingReasonText, this.rate).subscribe(data => {
    ...
    DisplayComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/display/display.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./display.component.scss */
      "./src/app/user/display/display.component.scss")).default]
    })], DisplayComponent);
    /***/
  },
  ...
  /***/
  function srcAppUserEditEditComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppUserEditEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_utility_utility_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/utility/utility.service */
    "./src/app/utility/utility.service.ts");
    /* harmony import */
    ...
    var src_app_app_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/app.service */
    "./src/app/app.service.ts");
    /* harmony import */


    var src_app_sign_in_sign_in_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _ionic_native_document_viewer_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    ...
    let EditComponent = class EditComponent {
      constructor(router, document, transfer, storage, fileChooser, filePath, file, userService, signinService, fb, camera, utility, actionSheetController) {
        ...
        this.willingToTravelArray = [{
          value: '1',
          label: 'Yes on production dime',
          selected: false
        }, {
          value: '2',
          label: 'Yes on own dime',
          selected: false
        }, {
          value: '3',
          label: 'No',
      ...
      otpPhoneVerified() {
        ...
        this.userService.otpPhoneVerified(this.otp, this.usersId).subscribe(data => {
      ...
      get t() {
        return this.talenteditform.controls;
      }

      get c() {
        return this.creweditform.controls;
      }
      ...
      uploadResume(resumeInput) {
        if (this.editform.controls.resume.value) {
          ...
          one$.subscribe({
            next: value => {
              this.userService.uploadResume(this.selectedFile.src, this.id).subscribe(res => {});
            }
          });
        } else {
          return true;
          ...
          one$.subscribe({
            next: value => {
              ...
              this.userService.uploadResume(this.selectedFile.src, this.id).subscribe(res => {
                ...
                this.profileImage = this.profileImage.data.image; //this.updateLocalStorage(this.profileImage);
              });
            }
          });
        } else {}
      ...
      talentUpdate() {
        return new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"](observer => {
          ...
          if (this.talenteditform.invalid) {
            ...
            this.userService.updateTalent(this.id, this.talenteditform.value).subscribe(data => {
              this.usersDetails = data;
              this.usersDetails = this.usersDetails.data.userDetails;
              ...
              this.utility.showToast('Something went wrong please try again.'); // this.istalentPosted = 2;
              // setTimeout(() => {
              //   this.istalentPosted = 0;
              // }, 3000)
            });
      ...
      crewUpdate() {
        return new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"](observer => {
          ...
          if (this.creweditform.invalid) {
            ...
            this.userService.updateCrew(this.id, this.creweditform.value).subscribe(data => {
              this.usersDetails = data;
              this.usersDetails = this.usersDetails.data.userDetails;
      ...
      vendorUpdate() {
        return new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"](observer => {
          ...
          this.userService.updateVendor(this.id, this.vendorEditform.value).subscribe(data => {
            this.usersDetails = data;
            this.usersDetails = this.usersDetails.data.userDetails;
            localStorage.removeItem("currentUser");
            localStorage.setItem('currentUser', JSON.stringify(this.usersDetails));
            this.usersType = this.usersDetails.usersType;
            this.usersTypeArr = this.usersDetails.usersTypeId;
            observer.next(true); // this.isvendorPosted = 1;
            // setTimeout(() => {
            //     this.isvendorPosted = 0;
            // }, 2000)
          }, error => {// this.isvendorPosted = 2;
            // setTimeout(() => {
            //     this.isvendorPosted = 0;
            // }, 2000)
          });
      ...
      getEmailNotificationSettings() {
        this.userService.getUserEmailNotificationMap(this.usersId, this.usersDetails.usersTypeId).subscribe(data => {
      ...
      userUpdateAll() {
        this.utility.showToast('Your profile has been successfully updated.'); // this.router.navigateByUrl('/gigs/Crew');
      ...
      changeTab(item) {
        ...
        if (item == 'profileTab') {//this.router.navigate['']
        }
      }
      ...
      processFile(imageInput, type) {
        switch (type) {
          case 'profileImage':
            ...
            this.userService.uploadImage(this.imagedata, this.id).subscribe(res => {
              //this.usersDetails = currentUser;
              let profileImage = res;
              this.profileImage = profileImage.data.image; //this.updateLocalStorage(this.profileImage);
            });
            break;

          case 'addtionalPhoto':
            this.usersImages = imageInput;
            this.userService.uploadAdditionalImage(this.imagedata, this.id).subscribe(res => {
              //this.usersDetails = currentUser;
              let profileImage = res;
              this.usersImages = profileImage.data.image; //this.updateLocalStorage(this.profileImage);
            });
            break;
      ...
      switchClicked(event, notificationId, mapId) {
        ...
        if (notificationId == '1' || notificationId == '2') {
          let emailNoti = this.emailNotifications.find(o => {
            return o.emailNotificationId == notificationId;
          });
          relatedVal = emailNoti.relatedVal;
        }

        this.userService.updateUserEmailNotifications(this.usersId, status, mapId, notificationId, relatedVal).subscribe(data => {
          let notification = this.emailNotifications.find(o => {
            return o.emailNotificationMapId == mapId;
          });
          notification.status = status;
        }, error => {});
      }

      deleteImage() {// console.log(this.imageId) ;
      ...
      getVideoDetails(e) {
        ...
        if (file) {
          ...
          reader.onload = event => {
            ...
            this.userService.uploadVideo(this.url, this.id).subscribe(res => {
              //console.log(res) ;
              this.userVideos = res;
              this.loadVideo = false; //this.usersImages = this.usersImages.data.image;

              this.userVideos = this.userVideos.data.allVideos; //console.log("===== User Video =======") ;

              localStorage.removeItem("profileVideo");
              localStorage.setItem('profileVideo', this.userVideos[0].video); //console.log(this.userVideos) ;
            }, error => {
              this.loadVideo = false;
            });
          };
      ...
      getAllVideos() {
        this.userService.getAllVideos(this.usersId).subscribe(data => {
    ...
    EditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./edit.component.scss */
      "./src/app/user/edit/edit.component.scss")).default]
    })], EditComponent);
    /***/
  },
  ...
  /***/
  function srcAppUserFavouriteFavouriteComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserFavouriteFavouriteComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _search_search_favourite_search_favourite_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../search/search-favourite/search-favourite.component */
    ...
    var _utility_utility_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../utility/utility.service */
    "./src/app/utility/utility.service.ts");
    /* harmony import */


    var _sign_in_sign_in_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    let FavouriteComponent = class FavouriteComponent {
      ...
      search() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          modal.onDidDismiss().then(searchData => {
      ...
      checkedSelected(favorite) {
        ...
        if (favorite.selected) {
          ...
          this.removedSelectedArray.push(obj); //this.removedSelectedArray.push(favorite.favouriteId);
        } else {
      ...
      pageChange(newPage) {
        ...
        this.start = (newPage - 1) * this.limit; // this.onSearch();
      }
    ...
    FavouriteComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/favourite/favourite.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./favourite.component.scss */
      "./src/app/user/favourite/favourite.component.scss")).default]
    })], FavouriteComponent);
    /***/
  },
  ...
  /***/
  function srcAppUserForgotPasswordForgotPasswordComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppUserForgotPasswordForgotPasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ForgotPasswordComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/user/forgot-password/forgot-password.component.scss")).default]
  ...
  /***/
  function srcAppUserListListComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_search_search_crew_search_crew_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/search/search-crew/search-crew.component */
    ...
    var src_app_search_search_user_search_user_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/search/search-user/search-user.component */
    "./src/app/search/search-user/search-user.component.ts");
    /* harmony import */


    var src_app_search_search_producer_search_producer_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/search/search-producer/search-producer.component */
    "./src/app/search/search-producer/search-producer.component.ts");
    /* harmony import */


    var src_app_search_search_vendor_search_vendor_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! src/app/search/search-vendor/search-vendor.component */
    "./src/app/search/search-vendor/search-vendor.component.ts");
    /* harmony import */


    var src_app_utility_utility_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! src/app/utility/utility.service */
    "./src/app/utility/utility.service.ts");
    ...
    let ListComponent = class ListComponent {
      ...
      fetchData(userType) {
        switch (userType) {
          case 'talent':
            this.userService.getTalents(this.usersId).subscribe(response => {
          ...
          case 'crew':
            this.userService.getCrews(this.usersId).subscribe(response => {
              this.listDetails = response;
          ...
          case 'producer':
            this.userService.getProducers(this.usersId).subscribe(response => {
              this.listDetails = response;
              this.listDetails = this.listDetails.data.crews;
              this.noTalentFound = 0;
          ...
          case 'vendor':
            this.userService.getVendors(this.usersId).subscribe(response => {
              this.listDetails = response;
      ...
      search() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          modal.onDidDismiss().then(searchForm => {
            if (searchForm.data) {
      ...
      addToFavorite(i, isFavourite) {
        if (isFavourite == 0) {
          this.userService.addFavorite(this.listDetails[i].usersId, this.usersId, this.userType).subscribe(data => {
          ...
          this.userService.removeFavorite(this.listDetails[i].usersId, this.usersId, this.userType).subscribe(data => {
            let favoriteDetails = data;
    ...
    ListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/list/list.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./list.component.scss */
      "./src/app/user/list/list.component.scss")).default]
    })], ListComponent);
    /***/
  },
  ...
  /***/
  function srcAppUserMyGigMyGigComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserMyGigMyGigComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MyGigComponent", function () {
      return MyGigComponent;
    });
    /* harmony import */
    ...
    var _search_search_mygig_search_mygig_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../search/search-mygig/search-mygig.component */
    ...
    let MyGigComponent = class MyGigComponent {
      ...
      filter() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          modal.onDidDismiss().then(selectedGigs => {
    ...
    MyGigComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-my-gig',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./my-gig.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user/my-gig/my-gig.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./my-gig.component.scss */
      "./src/app/user/my-gig/my-gig.component.scss")).default]
    })], MyGigComponent);
    /***/
  },
  ...
  function srcAppUserUserRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _favourite_favourite_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _my_gig_my_gig_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./my-gig/my-gig.component */
    "./src/app/user/my-gig/my-gig.component.ts");
    /* harmony import */
  ...
  function srcAppUserUserModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _favourite_favourite_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./favourite/favourite.component */
    "./src/app/user/favourite/favourite.component.ts");
    /* harmony import */
    ...
    var _change_password_change_password_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./change-password/change-password.component */
    "./src/app/user/change-password/change-password.component.ts");
    /* harmony import */


    var _my_gig_my_gig_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./my-gig/my-gig.component */
    "./src/app/user/my-gig/my-gig.component.ts");
    /* harmony import */
    ...
    UserPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _user_routing_module__WEBPACK_IMPORTED_MODULE_5__["UserPageRoutingModule"]],
      declarations: [_forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_8__["ForgotPasswordComponent"], _change_password_change_password_component__WEBPACK_IMPORTED_MODULE_11__["ChangePasswordComponent"], _favourite_favourite_component__WEBPACK_IMPORTED_MODULE_6__["FavouriteComponent"], _edit_edit_component__WEBPACK_IMPORTED_MODULE_9__["EditComponent"], _display_display_component__WEBPACK_IMPORTED_MODULE_10__["DisplayComponent"], _my_gig_my_gig_component__WEBPACK_IMPORTED_MODULE_12__["MyGigComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_13__["ListComponent"]]
    })], UserPageModule);
    /***/
  }
}]);
